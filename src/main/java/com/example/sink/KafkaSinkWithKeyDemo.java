...
/***
 * @author: BYDylan
 * @date: 2024-09-21 15:12:19
 * @description: 输出到kafka, 自定义序列化器
 */
public class KafkaSinkWithKeyDemo {
    public static void main(String[] args) throws Exception {
        ...
        /**
         * 如果要指定写入kafka的key 可以自定义序列器： 1、实现 一个接口, 重写 序列化 方法 2、指定key, 转成 字节数组 3、指定value, 转成 字节数组 4、返回一个 ProducerRecord对象,
         * 把key、value放进去
         */
