...
/***
 * @author: BYDylan
 * @date: 2024-09-22 18:16:30
 * @description: flink去消费 被 两阶段提交的 topic, 设置隔离级别
 */
public class KafkaEOSDemo2 {
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<String> kafkaSource = KafkaSource.<String>builder()
            .setBootstrapServers("hadoop102:9092,hadoop103:9092,hadoop104:9092").setGroupId("atguigu").setTopics("ws")
            .setValueOnlyDeserializer(new SimpleStringSchema()).setStartingOffsets(OffsetsInitializer.latest())
            // 作为 下游的消费者, 要设置 事务的隔离级别 = 读已提交
            .setProperty(ConsumerConfig.ISOLATION_LEVEL_CONFIG, "read_committed").build();
