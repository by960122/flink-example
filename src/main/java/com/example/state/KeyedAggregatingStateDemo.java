...
/***
 * @author: BYDylan
 * @date: 2024-09-22 17:27:41
 * @description: 按键分区状态-聚合状态: 计算每种传感器的平均水位
 */
        ...
        sensorDS.keyBy(WaterSensor::getId).process(new KeyedProcessFunction<String, WaterSensor, String>() {
            ...
            public void open(Configuration parameters) throws Exception {
                ...
                vcAvgAggregatingState = getRuntimeContext().getAggregatingState(
                    new AggregatingStateDescriptor<Integer, Tuple2<Integer, Integer>, Double>("vcAvgAggregatingState",
