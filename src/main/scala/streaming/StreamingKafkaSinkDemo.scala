...
object StreamingKafkaSinkDemo {
  def main(args: Array[String]): Unit = {
    ...
    val myProducer = new FlinkKafkaProducer[String](topic, new MyKafkaSerializationSchema2(topic + "_out"), prop, FlinkKafkaProducer.Semantic.EXACTLY_ONCE);
    //    过期了
